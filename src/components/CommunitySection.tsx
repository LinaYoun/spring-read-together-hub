...
const CommunitySection = () => {
  return <section className="mb-16">
      <div className="bg-bookish-maroon/10 rounded-lg p-8 border border-bookish-maroon/20 text-center">
        ...
        <p className="text-bookish-dark mb-6 max-w-2xl mx-auto">Connect with fellow book lovers, participate in discussions, access exclusive content, and stay updated with all our club activities. We meet bi-weekly to discuss great literature in English.</p>
