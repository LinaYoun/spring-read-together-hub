...
const Navigation = () => {
  ...
  const navItems = [
    ...
    { title: "Book Club", path: "/book-club", icon: BookOpen },
    { title: "Workshop", path: "/workshop", icon: Briefcase },
  ...
  return (
    <>
      <div className="flex justify-between items-center py-4 px-6 border-b border-bookish-maroon/30">
        ...
        <Link to="/" className="text-3xl font-serif italic text-bookish-maroon font-bold">Bookish</Link>
